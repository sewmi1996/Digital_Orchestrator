...
import { NodeModel, ConnectorModel, SymbolPalette, Connector, SymbolInfo, Diagram, PortVisibility, BpmnDiagrams, PortConstraints, NodeConstraints } from '@syncfusion/ej2-diagrams';
...
export function getBasicShapes(): NodeModel[] {
    ...
    let basicShapes: NodeModel[] = [
        ...
        { width: 100, height: 100, offsetX: 300, offsetY: 100,
            id:'path',
      shape: { type: 'Path', data: 'M8.6 223.9c0 0 143.5 3.4 185.8-181.8 2.7-11.7-1.2-20.2 1.3-33.1h16.3c0 0-3.1 17.2 1.1 30.8 21.4 68.7-4.2 242.3-204.2 196.6L8.6 223.9zM8.8 230.3c0 0 188.2 40.2 196.5-160.1' },
      style: { fill: 'blue'}},
      { width: 100, height: 100, offsetX: 300, offsetY: 100, id:'curve', shape: { type: 'Path', data: 'M150,150 A100,70 0 0,1 250,220' }}
    ];
...
export function generatePalette(): void {
    let palette: SymbolPalette = new SymbolPalette({
        ...
        width: '100%', height: '100%', symbolHeight: 100, symbolWidth: 100,
