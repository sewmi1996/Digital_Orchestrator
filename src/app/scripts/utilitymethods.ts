...
export class UtilityMethods {
    ...
    public flowChartImage: { [key: string]: string }[] = [
        { source: './assets/syncfusion/dbstyle/common_images/blank_diagram.svg', name: 'Blank Diagram', type: 'svg_blank' },
        { source: './assets/syncfusion/dbstyle/flowchart_Images/Credit_Card_Processing.svg', name: 'Credit Card Processing', type: 'svg_image' },
        { source: './assets/syncfusion/dbstyle/flowchart_Images/Bank_Teller_Flow.svg', name: 'Banking Teller Process Flow', type: 'svg_image' },
        { source: './assets/syncfusion/dbstyle/flowchart_Images/Developer_Workflow.SVG', name: 'Agile"s Developer Workflow', type: 'svg_image' },
    ];

    public mindMapImage: { [key: string]: string }[] = [
        { source: './assets/syncfusion/dbstyle/common_images/blank_diagram_mind.svg', name: 'Blank Diagram', type: 'svg_image' },
        { source: './assets/syncfusion/dbstyle/mindmap_images/BusinessPlanning.SVG', name: 'Business Planning', type: 'svg_image' },
        { source: './assets/syncfusion/dbstyle/mindmap_images/TQM.SVG', name: 'Quality Management', type: 'svg_image' },
        { source: './assets/syncfusion/dbstyle/mindmap_images/SoftwareLifeCycle.SVG', name: 'Software Life Cycle', type: 'svg_image' },
    ];

    public orgChartImage: { [key: string]: string }[] = [
        { source: './assets/syncfusion/dbstyle/common_images/blank_diagram_org.svg', name: 'Blank Diagram', type: 'svg_image' },
        { source: './assets/syncfusion/dbstyle/orgchart_images/OrgRenderingStyle_1.svg', name: 'Org Template Style - 1', type: 'svg_image' },
        { source: './assets/syncfusion/dbstyle/orgchart_images/OrgRenderingStyle_2.svg', name: 'Org Template Style - 2', type: 'svg_image' },
        { source: './assets/syncfusion/dbstyle/orgchart_images/OrgRenderingStyle_3.svg', name: 'Org Template Style - 3', type: 'svg_image' },
    ];

    public bpmnImage: { [key: string]: string }[] = [
        { source: './assets/syncfusion/dbstyle/common_images/blank_diagram.svg', name: 'Blank Diagram', type: 'svg_blank' },
        { source: './assets/syncfusion/dbstyle/bpmn_images/Template1.png', name: 'BPMN Diagram 1' },
        { source: './assets/syncfusion/dbstyle/bpmn_images/Template1.png', name: 'BPMN Diagram 2' },
        { source: './assets/syncfusion/dbstyle/bpmn_images/Template1.png', name: 'BPMN Diagram 3' },
    ];
    ...
    public generateDiagram(selectedItem: SelectorViewModel, evt: MouseEvent): void {
        ...
        if (target.id.startsWith('mindmap')) {
            ...
            if (target.id === 'mindmap_child0') {
                ...
                this.readTextFile('./assets/syncfusion/dbstyle/mindmap_images/BusinessPlanning.json', selectedItem);
                MindMapUtilityMethods.templateType = 'template1';
            } else if (target.id === 'mindmap_child2') {
                mindMapObject.createMindMap(false);
                this.readTextFile('./assets/syncfusion/dbstyle/mindmap_images/TQM.json', selectedItem);
                MindMapUtilityMethods.templateType = 'template2';
            } else if (target.id === 'mindmap_child3') {
                mindMapObject.createMindMap(false);
                this.readTextFile('./assets/syncfusion/dbstyle/mindmap_images/SoftwareDevelopmentLifeCycle.json', selectedItem);
                MindMapUtilityMethods.templateType = 'template1';
            }
            this.hideMenuItems();
            ...
            if (target.id === 'orgchart_child0') {
                ...
                if (target.id === 'orgchart_child1') {
                    ...
                    this.readTextFile('./assets/syncfusion/dbstyle/orgchart_images/OrgTemplateStyle1.json', selectedItem);
                } else if (target.id === 'orgchart_child2') {
                    orgChartObject.createOrgChart(false);
                    this.readTextFile('./assets/syncfusion/dbstyle/orgchart_images/OrgTemplateStyle2.json', selectedItem);
                } else if (target.id === 'orgchart_child3') {
                    orgChartObject.createOrgChart(false);
                    this.readTextFile('./assets/syncfusion/dbstyle/orgchart_images/OrgTemplateStyle3.json', selectedItem);
                }
            }
            this.hideMenuItems();
            diagramContainer.classList.add('custom-diagram');
            ...
            if (target.id === 'flowchart_child0') {
                ...
                this.readTextFile('./assets/syncfusion/dbstyle/flowchart_Images/CreditCardFlow.json', selectedItem);
            } else if (target.id === 'flowchart_child2') {
                this.readTextFile('./assets/syncfusion/dbstyle/flowchart_Images/BankingTellerProcess.json', selectedItem);
            } else if (target.id === 'flowchart_child3') {
                this.readTextFile('./assets/syncfusion/dbstyle/flowchart_Images/Developer_Workflow.json', selectedItem);
            }
        ...
        for (let i: number = 0; i < selectedItem.selectedDiagram.nodes.length; i++) {
            ...
            if (node.id !== 'textNode') {
                ...
                if (!imageField) {
                    ...
                    selectedItem.selectedDiagram.dataBind();
                    node.shape = {
                        type: 'Image', source: nodeInfo[propName] && nodeInfo[propName].value ? nodeInfo[propName].value.toString() : './assets/syncfusion/dbstyle/orgchart_images/blank-male.jpg',
